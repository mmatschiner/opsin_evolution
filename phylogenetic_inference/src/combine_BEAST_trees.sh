...
python3 logcombiner.py -b 10 ${combined_dir}/tree_files.txt ${combined_dir}/${combined_trees_file_name}
python3 logcombiner.py -b 10 ${combined_dir}/log_files.txt ${combined_dir}/${combined_log_file_name}

# Run TreeAnnotator to produce a MCC tree from the tree sample.
java -jar ../bin/treeannotator.jar -heights mean ${combined_dir}/${combined_trees_file_name} ${combined_dir}/${mcc_tree_file_name}